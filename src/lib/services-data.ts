...
export const servicesData: ServiceSection[] = [
    ...
    subsections: [
      {
        ...
        services: [
          { id: "s1", name: "الصفحة الرئيسية (عربي / إنجليزي / أوردو)" },
      ...
      },
      {
        ...
        services: [
          { id: "s28", name: "المُقترَب — منصة مشاركة المحتوى من القرّاء" },
          { id: "s29", name: "المِرقَب — أداة رصد ومؤشرات إخبارية" },
          { id: "s30", name: "النشرات الصوتية — ملخصات أخبار صوتية" },
          { id: "s31", name: "عُمق (التحليل المعمّق)" },
          { id: "s32", name: "الموجز اليومي — ملخص يومي شامل" },
          { id: "s33", name: "التغطية اللحظية (لحظة بلحظة)" },
          { id: "s34", name: "التغطية الخليجية الحية" },
      ...
      {
        id: "ads-portal",
        title: "بوابة الإعلانات (الخدمة الذاتية)",
        services: [
          { id: "s38", name: "صفحة هبوط للمعلنين" },
          { id: "s39", name: "تسجيل حساب معلن" },
          { id: "s40", name: "تسجيل دخول المعلنين" },
          { id: "s41", name: "إنشاء حملات إعلانية" },
        ],
      },
      {
        id: "info-pages",
  ...
  },
  {
    ...
    subsections: [
      ...
      },
      {
        ...
        services: [
          { id: "s75", name: "إدارة الإعلانات العادية" },
          { id: "s76", name: "إدارة الإعلانات المدمجة (Native Ads)" },
          { id: "s77", name: "تقارير أداء الحملات" },
        ],
      },
      {
        id: "mirqab-tools",
  ...
  {
    id: "ifox",
    title: "نظام iFox للذكاء الاصطناعي",
    icon: "🦊",
    color: "from-orange-500 to-red-500",
    subsections: [
      {
        id: "ifox-dashboard",
        title: "لوحة تحكم iFox",
        services: [
          { id: "s87", name: "نظرة عامة على نشاط الذكاء الاصطناعي" },
          { id: "s88", name: "حالة المهام والإنتاج" },
        ],
      },
      {
        id: "ai-management",
        ...
        services: [
          { id: "s89", name: "تفضيلات الذكاء الاصطناعي (اختيار النماذج، ضبط المعايير)" },
          { id: "s90", name: "التقويم التحريري الذكي" },
          { id: "s91", name: "إدارة الميزانية (Budget Manager)" },
          { id: "s92", name: "قواعد سير العمل الآلي (Workflow Rules)" },
          { id: "s93", name: "فحوصات الجودة (Quality Checks)" },
        ],
      },
      {
        id: "ai-content-gen",
        ...
        services: [
          { id: "s94", name: "مولّد المقالات (عربي، إنجليزي، أوردو)" },
          { id: "s95", name: "دعم أنواع متعددة: خبر، تحليل، تقرير، مقابلة، رأي" },
          { id: "s96", name: "دعم نبرات مختلفة: رسمية، عامية، استقصائية، محايدة" },
          { id: "s97", name: "توليد مسودات من أحداث التقويم التحريري" },
          { id: "s98", name: "جدولة مهام التوليد الآلي" },
        ],
      },
      {
        id: "ai-tasks",
        title: "إدارة مهام الذكاء الاصطناعي",
        services: [
          { id: "s99", name: "عرض المهام المعلقة والمنجزة" },
          { id: "s100", name: "تنفيذ المهام المجدولة تلقائياً" },
          { id: "s101", name: "متابعة حالة كل مهمة" },
        ],
      },
    ],
  },
    ...
    subsections: [
      {
        ...
        title: "نظام الولاء",
        services: [
          { id: "s127", name: "نظام النقاط (Loyalty Points)" },
          { id: "s128", name: "لوحة المتصدرين (Leaderboard)" },
          { id: "s129", name: "المهام اليومية والتحديات" },
          { id: "s130", name: "شارات الإنجاز" },
          { id: "s131", name: "مستويات المستخدمين" },
        ],
      },
    ],
  },
    ...
    subsections: [
      {
        ...
        services: [
          ...
          { id: "s152", name: "الأوردو — واجهة كاملة + محتوى" },
